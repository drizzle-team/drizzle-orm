...
import { check, drop, exportRaw, generate, migrate, pull, push, reset, studio, up } from './schema';
...
run([generate, migrate, pull, push, studio, up, check, drop, reset, exportRaw, ...legacy], {
	name: 'drizzle-kit',
	version: version,
});
