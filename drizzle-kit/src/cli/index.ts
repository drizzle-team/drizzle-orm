...
import { check, drop, exportRaw, generate, migrate, pull, push, studio, up, update } from './schema';
...
run([generate, migrate, pull, push, studio, up, check, drop, exportRaw, update, ...legacy], {
	name: 'drizzle-kit',
	version: version,
});
