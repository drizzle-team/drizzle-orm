...
result.PGArrayExpression = makeRecipe([
  ...
  "Array",
  {
          ...
          [
            ...
            [
              ...
              [
                ...
                ["alt", { sourceInterval: [174, 194] }, ["terminal", { sourceInterval: [174, 178] }, '"'], ["app", { sourceInterval: [181, 194] }, "escapedSymbol", []]],
              ],
    ...
    quotelessString: [
      ...
      [
        ...
        [
          ...
          ["not", { sourceInterval: [252, 280] }, ["app", { sourceInterval: [253, 280] }, "forbiddenSymbolForQuoteless", []]],
    ...
    escapedSymbol: [
      ...
      null,
      [],
      ["seq", { sourceInterval: [305, 313] }, ["terminal", { sourceInterval: [305, 309] }, "\\"], ["app", { sourceInterval: [310, 313] }, "any", []]],
    ],
    nullLiteral: ["define", { sourceInterval: [319, 339] }, null, [], ["terminal", { sourceInterval: [333, 339] }, "NULL"]],
...
result.PGArrayLiteral = makeRecipe([
  ...
  "Array",
  {
          ...
          [
            ...
            [
              ...
              [
                ...
                ["alt", { sourceInterval: [165, 185] }, ["terminal", { sourceInterval: [165, 169] }, '"'], ["app", { sourceInterval: [172, 185] }, "escapedSymbol", []]],
              ],
    ...
    quotelessString: [
      ...
      [
        ...
        [
          ...
          ["not", { sourceInterval: [243, 271] }, ["app", { sourceInterval: [244, 271] }, "forbiddenSymbolForQuoteless", []]],
    ...
    escapedSymbol: [
      ...
      null,
      [],
      ["seq", { sourceInterval: [296, 304] }, ["terminal", { sourceInterval: [296, 300] }, "\\"], ["app", { sourceInterval: [301, 304] }, "any", []]],
    ],
    nullLiteral: ["define", { sourceInterval: [311, 331] }, null, [], ["terminal", { sourceInterval: [325, 331] }, "NULL"]],
    forbiddenSymbolForQuoteless: [
      "define",
