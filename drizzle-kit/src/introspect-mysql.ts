...
export const schemaToTypeScript = (
  ...
  const tableStatements = Object.values(schema.tables).map((table) => {
    ...
    statement += `export const ${withCasing(table.name)} = ${func}("${
      table.name
    }", {\n`;
...
const column = (
  ...
  if (lowered.startsWith("tinyint")) {
    ...
    let out: string = `${casing(name)}: tinyint("${name}"${
      isUnsigned ? ", { unsigned: true }" : ""
    })`;
    out += autoincrement ? `.autoincrement()` : "";
    out +=
  ...
  if (lowered.startsWith("smallint")) {
    ...
    let out = `${casing(name)}: smallint("${name}"${
      isUnsigned ? ", { unsigned: true }" : ""
    })`;
    out += autoincrement ? `.autoincrement()` : "";
    out += defaultValue
  ...
  if (lowered.startsWith("mediumint")) {
    ...
    let out = `${casing(name)}: mediumint("${name}"${
      isUnsigned ? ", { unsigned: true }" : ""
    })`;
    out += autoincrement ? `.autoincrement()` : "";
    out += defaultValue
  ...
  if (lowered.startsWith("bigint")) {
    ...
    let out = `${casing(name)}: bigint("${name}", { mode: "number"${
      isUnsigned ? ", unsigned: true" : ""
    } })`;
    out += autoincrement ? `.autoincrement()` : "";
    out += defaultValue
