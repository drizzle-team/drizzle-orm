...
describe('commutativity integration (postgres)', () => {
  test('column conflict: both branches change same column', async () => {
    ...
    a.columns.push({ schema: 'public', table: 'users', name: 'email', type: 'varchar', options: null, typeSchema: 'pg_catalog', notNull: false, dimensions: 0, default: null, generated: null, identity: null } as any);
    const b = createDDL();
    b.tables.push({ schema: 'public', isRlsEnabled: false, name: 'users' });
    b.columns.push({ schema: 'public', table: 'users', name: 'email', type: 'varchar', options: null, typeSchema: 'pg_catalog', notNull: true, dimensions: 0, default: null, generated: null, identity: null } as any);
  ...
  test('table drop vs child column alter', async () => {
    ...
    parent.columns.push({ schema: 'public', table: 't1', name: 'c1', type: 'varchar', options: null, typeSchema: 'pg_catalog', notNull: false, dimensions: 0, default: null, generated: null, identity: null } as any);
    ...
    b.columns.push({ schema: 'public', table: 't1', name: 'c1', type: 'varchar', options: null, typeSchema: 'pg_catalog', notNull: true, dimensions: 0, default: null, generated: null, identity: null } as any);
    ...
    const report = await detectNonCommutative(files, 'postgresql');
    expect(report.conflicts.some(c => c.reasons.some(r => r.includes('Dropping a table')))).toBe(true);
  });
  ...
  test('unique constraint same name on same table', async () => {
    ...
    a.uniques.push({ schema: 'public', table: 't2', nameExplicit: true, name: 't2_uq', columns: ['c'], nullsNotDistinct: false } as any);
    const b = createDDL();
    b.tables.push({ schema: 'public', isRlsEnabled: false, name: 't2' });
    b.uniques.push({ schema: 'public', table: 't2', nameExplicit: true, name: 't2_uq', columns: ['c'], nullsNotDistinct: false } as any);
  ...
  test('view: same name in both branches', async () => {
    ...
    const a = createDDL();
    a.views.push({ schema: 'public', name: 'v1', materialized: false, definition: null, with: null, withNoData: null, using: { name: 'sql', default: true }, tablespace: null } as any);
    const b = createDDL();
    b.views.push({ schema: 'public', name: 'v1', materialized: false, definition: null, with: null, withNoData: null, using: { name: 'sql', default: true }, tablespace: null } as any);
  ...
  test('sequence: same name in both branches', async () => {
    ...
    const a = createDDL();
    a.sequences.push({ schema: 'public', name: 's1', incrementBy: null, minValue: null, maxValue: null, startWith: null, cacheSize: null, cycle: null } as any);
    const b = createDDL();
    b.sequences.push({ schema: 'public', name: 's1', incrementBy: null, minValue: null, maxValue: null, startWith: null, cacheSize: null, cycle: null } as any);
  ...
  test('policy: same name on same table in both branches', async () => {
    ...
    a.policies.push({ schema: 'public', table: 't3', name: 'pol', as: 'PERMISSIVE', for: 'SELECT', roles: ['PUBLIC'], using: null, withCheck: null } as any);
    const b = createDDL();
    b.tables.push({ schema: 'public', isRlsEnabled: false, name: 't3' });
    b.policies.push({ schema: 'public', table: 't3', name: 'pol', as: 'PERMISSIVE', for: 'SELECT', roles: ['PUBLIC'], using: null, withCheck: null } as any);
  ...
  test('RLS toggle conflict for the same table', async () => {
    ...
    a.policies.push({ schema: 'public', table: 't_rls', name: 'p_rls', as: 'PERMISSIVE', for: 'SELECT', roles: ['PUBLIC'], using: null, withCheck: null } as any);
  ...
  test('three-way branch: A,B,C from same parent', async () => {
    ...
    const a = createDDL(); a.tables.push({ schema: 'public', isRlsEnabled: false, name: 't' }); a.columns.push({ schema: 'public', table: 't', name: 'a', type: 'varchar', options: null, typeSchema: 'pg_catalog', notNull: false, dimensions: 0, default: null, generated: null, identity: null } as any);
    const b = createDDL(); b.tables.push({ schema: 'public', isRlsEnabled: false, name: 't' }); b.columns.push({ schema: 'public', table: 't', name: 'a', type: 'varchar', options: null, typeSchema: 'pg_catalog', notNull: true, dimensions: 0, default: null, generated: null, identity: null } as any);
    const c = createDDL(); c.tables.push({ schema: 'public', isRlsEnabled: false, name: 't' }); c.columns.push({ schema: 'public', table: 't', name: 'b', type: 'varchar', options: null, typeSchema: 'pg_catalog', notNull: false, dimensions: 0, default: null, generated: null, identity: null } as any);
  ...
  test('nested branching: parent -> A -> A1 and parent -> B', async () => {
    ...
    const A = createDDL(); A.tables.push({ schema: 'public', isRlsEnabled: false, name: 't' }); A.columns.push({ schema: 'public', table: 't', name: 'c', type: 'varchar', options: null, typeSchema: 'pg_catalog', notNull: false, dimensions: 0, default: null, generated: null, identity: null } as any);
    const A1 = createDDL(); A1.tables.push({ schema: 'public', isRlsEnabled: false, name: 't' }); A1.columns.push({ schema: 'public', table: 't', name: 'c', type: 'varchar', options: null, typeSchema: 'pg_catalog', notNull: true, dimensions: 0, default: null, generated: null, identity: null } as any);
    const B = createDDL(); B.tables.push({ schema: 'public', isRlsEnabled: false, name: 't' }); B.columns.push({ schema: 'public', table: 't', name: 'd', type: 'varchar', options: null, typeSchema: 'pg_catalog', notNull: false, dimensions: 0, default: null, generated: null, identity: null } as any);
  ...
  test('complex mixed: multiple tables, enums, views, and policies diverging', async () => {
    ...
    X.columns.push({ schema: 'public', table: 'u', name: 'email', type: 'varchar', options: null, typeSchema: 'pg_catalog', notNull: true, dimensions: 0, default: null, generated: null, identity: null } as any);
    X.views.push({ schema: 'public', name: 'v_users', materialized: false, definition: null, with: null, withNoData: null, using: { name: 'sql', default: true }, tablespace: null } as any);
    ...
    Y.policies.push({ schema: 'public', table: 'p', name: 'pol_p', as: 'PERMISSIVE', for: 'SELECT', roles: ['PUBLIC'], using: null, withCheck: null } as any);
    ...
    const report = await detectNonCommutative(files, 'postgresql');
    expect(report.conflicts.some(c => c.reasons.some(r => r.includes('Dropping a table conflicts')))).toBe(true);
    expect(report.conflicts.length).toBeGreaterThan(0);
  });

  test.only('complex schema and moves: rename, move, drop schema/table conflicts', async () => {
    const { tmp } = mkTmp();
    const files: string[] = [];
    ...
    expect(report.conflicts.length).toBeGreaterThan(0);
    expect(report.conflicts.some(c => c.reasons.some(r => r.includes('Dropping a schema conflicts')))).toBe(true);
