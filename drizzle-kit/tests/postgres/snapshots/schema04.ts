...
export const allByteaCustom = customSchema.table('all_bytea_custom', {
	columnAll: bytea('column_all').notNull().array().generatedAlwaysAs([Buffer.from('32')]),
	column: bytea('column').default(Buffer.from('32')),
	columnPrimary: bytea('column_primary').primaryKey().notNull(),
});
...
export const allBytea = pgTable('all_bytea', {
	columnAll: bytea('column_all').notNull().array().generatedAlwaysAs([Buffer.from('32')]),
	column: bytea('column').default(Buffer.from('32')),
	columnPrimary: bytea('column_primary').primaryKey().notNull(),
	column3: bytea('column3').array().notNull(),
});
