...
// 			tableFrom: 'table2',
// 			tableTo: 'table1',
// 			type: 'fk_without_unique',
// 		},
// 	]);
// 	expect(mappedErrors1).toBe(``);
// 	expect(mappedErrors2).toBe(` Warning  Cannot create a foreign key from \`table2\` (\`column2\`)
// to \`table1\` (\`column1\`).
// Referenced columns must be part of a (COMPOSITE) PRIMARY KEY or have a (COMPOSITE) UNIQUE constraint`);
// 	await expect(push({ db, to })).rejects.toThrowError();
// });
...
// 	]);
// 	expect(mappedErrors1).toBe(``);
// 	expect(mappedErrors2).toBe(` Warning  Cannot create a foreign key from \`table2\` (\`column1\`, \`column2\`)
// to \`table1\` (\`column1\`, \`column2\`).
// Referenced columns must be part of a (COMPOSITE) PRIMARY KEY or have a (COMPOSITE) UNIQUE constraint`);
// 	await expect(push({ db, to })).rejects.toThrowError();
// });
...
// test('foreign key constraint errors #4', async () => {
// 	const table1 = mysqlTable('table1', {
// 		column1: int().unique(),
// 		column2: varchar({ length: 256 }).unique(),
// 	});
...
// 	expect(mappedErrors1).toBe(``);
// 	expect(mappedErrors2).toBe(` Warning  Cannot create a foreign key from \`table2\` (\`column1\`, \`column2\`)
// to \`table1\` (\`column2\`, \`column1\`).
// Referenced columns must be part of a (COMPOSITE) PRIMARY KEY or have a (COMPOSITE) UNIQUE constraint`);
// 	await expect(push({ db, to })).rejects.toThrowError();
// });

// test('foreign key constraint errors #5', async () => {
// 	const table1 = mysqlTable('table1', {
// 		column1: int(),
// 		column2: varchar({ length: 256 }),
// 	}, (t) => [primaryKey({ columns: [t.column1, t.column2] })]);
// 	const table2 = mysqlTable('table2', {
// 		column1: int(),
// 		column2: varchar({ length: 256 }),
// 		column3: text(),
...
// 	const { sqlStatements: st, ddl1Err, ddl2Err, mappedErrors1, mappedErrors2 } = await diff({}, to, []);
// 	// console.log('st: ', st);
// 	// const { hints, sqlStatements: pst } = await push({ db, to });
