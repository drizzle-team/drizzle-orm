...
class ImportAnalyzer {
  ...
  private importedFileFormatRegex =
    /^.*\.(ts|tsx|mts|cts|js|jsx|mjs|cjs|json)$/i;
  ...
  private localizePath = (path: string) =>
    relative(resolvePath(this.basePath), resolvePath(path));
  ...
  private isTsFormat = (path: string) =>
    this.importedFileFormatRegex.test(path);
