...
import QueryResponseMapper, { QueryResponseMapperV1 } from '../../../mappers/responseMapper';
...
export default abstract class AbstractJoined<TTable extends AbstractTable<TTable>, TRes, TPartial extends PartialFor<TTable> = {}> {
  ...
  protected fullOrPartial<Table extends AbstractTable<Table>, Partial extends PartialFor<Table>>(mappedServiceToDb: {
    ...
    if (partial) {
      return QueryResponseMapperV1.partialMap(partial, result, joinId) as Array<FullOrPartial<Table, Partial>>;
    }
    return QueryResponseMapperV1.map(mappedServiceToDb, result, joinId) as Array<FullOrPartial<Table, Partial>>;
  }
