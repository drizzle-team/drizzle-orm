...
export type ExtractFieldNames<TTable> = {
	[Key in (keyof TTable & string)]: TTable[Key] extends Function
		? never
		: TTable[Key] extends Column<ColumnType, any, any> // true extends TNullable ? never : Key
		? Key
		: TTable[Key] extends IndexedColumn<ColumnType, any, any>
		? Key
		: never;
...
export type ExtractOptionalFieldNames<TTable> = {
	[Key in keyof TTable]: TTable[Key] extends Function
		? never
...
export type ExtractModel<TTable> = any extends TTable
	? { [key: string]: any }
...
export type AnyColumn =
	| Column<ColumnType, boolean, boolean>
	| IndexedColumn<ColumnType, boolean, boolean>;

export type ExtractColumns<TTable extends AbstractTable<TTable>> = {
	[name in (keyof ExtractModel<TTable> & string)]: AbstractColumn<ColumnType>;
};
...
export type CheckTwoTypes<
	TInput,
	TTable extends AbstractTable<TTable>,
	TTable1 extends AbstractTable<TTable1>,
> = TInput extends AbstractTable<TTable>
	? TTable
	: TInput extends AbstractTable<TTable1>
	? TTable1
	: never;
export type CheckThreeTypes<
	TInput,
	TTable extends AbstractTable<TTable>,
	TTable1 extends AbstractTable<TTable1>,
	TTable2 extends AbstractTable<TTable2>,
> = TInput extends AbstractTable<TTable>
	? TTable
	: TInput extends AbstractTable<TTable1>
	? TTable1
	: TInput extends AbstractTable<TTable2>
	? TTable2
	: never;
export type CheckFourTypes<
	TInput,
	TTable extends AbstractTable<TTable>,
	TTable1 extends AbstractTable<TTable1>,
	TTable2 extends AbstractTable<TTable2>,
	TTable3 extends AbstractTable<TTable3>,
> = TInput extends AbstractTable<TTable>
	? TTable
	: TInput extends AbstractTable<TTable1>
	? TTable1
	: TInput extends AbstractTable<TTable2>
	? TTable2
	: TInput extends AbstractTable<TTable3>
	? TTable3
	: never;
export type CheckFiveTypes<
	TInput,
	TTable extends AbstractTable<TTable>,
	TTable1 extends AbstractTable<TTable1>,
	TTable2 extends AbstractTable<TTable2>,
	TTable3 extends AbstractTable<TTable3>,
	TTable4 extends AbstractTable<TTable4>,
> = TInput extends AbstractTable<TTable>
	? TTable
	: TInput extends AbstractTable<TTable1>
	? TTable1
	...
	: TInput extends AbstractTable<TTable3>
	? TTable3
	: TInput extends AbstractTable<TTable4>
	? TTable4
	: never;
