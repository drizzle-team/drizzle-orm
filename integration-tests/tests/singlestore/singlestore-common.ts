...
import type { DrizzleSingleStoreExtension } from 'drizzle-orm/extension-core/singlestore';
import { s3File, s3FileExt } from 'drizzle-orm/extensions/s3-file/singlestore';
...
const s3Table = singlestoreTable('s3files', {
	id: int('id'),
...
export async function createExtensions(): Promise<DrizzleSingleStoreExtension[]> {
