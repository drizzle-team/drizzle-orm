...
import { alias, cockroachdbTable, cockroachdbTableCreator, customType, int4, text } from 'drizzle-orm/cockroachdb-core';
...
const usersTable = cockroachdbTable('users', {
...
const usersMigratorTable = cockroachdbTable('users12', {
