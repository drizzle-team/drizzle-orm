...
import type { NodeCockroachDbDatabase } from 'drizzle-orm/cockroachdb';
import { drizzle } from 'drizzle-orm/cockroachdb';
import { cockroachdbTable, int4, timestamp } from 'drizzle-orm/cockroachdb-core';
import { migrate } from 'drizzle-orm/cockroachdb/migrator';
...
let db: NodeCockroachDbDatabase;
let client: Client;
