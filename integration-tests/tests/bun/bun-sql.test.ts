...
test('all types ~codecs~', async () => {
	...
	).toStrictEqual([{ value: new Date('2025-03-12 01:32:41.623') }, { value: new Date('2025-03-12 01:32:41.623+00') }]);
	expect(
		await unionAll(
			db.select({ value: allTypesTable.timestampTz }).from(allTypesTable),
			db.select({ value: allTypesTable.date }).from(allTypesTable),
	...
	).toStrictEqual([{ value: new Date('2025-03-12 01:32:41.623+00') }, { value: new Date('2025-03-12 01:32:41.623') }]);
	expect(
		await unionAll(
			db.select({ value: allTypesTable.timestampTz }).from(allTypesTable),
			db.select({ value: allTypesTable.timestampTz }).from(allTypesTable),
	...
	).toStrictEqual([{ value: { arr: ['strb', 11], str: 'strvalb' } }, { value: { arr: ['strb', 11], str: 'strvalb' } }]);
	expect(
		await unionAll(
			db.select({ value: allTypesTable.jsonb }).from(allTypesTable),
