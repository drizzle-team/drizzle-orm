...
export const allDataTypes = schema.table('all_data_types', {
	...
	numericNumber: numeric('numeric_number', { mode: 'number' }),
	decimal: decimal('decimal'),
	decimalNumber: decimal('decimal_number', { mode: 'number' }),
	real: real('real'),
...
export const allArrayDataTypes = schema.table('all_array_data_types', {
	...
	numericNumberArray: numeric('numeric_number_array', { mode: 'number' }).array(),
	decimalArray: decimal('decimal_array').array(),
	decimalNumberArray: decimal('decimal_number_array', { mode: 'number' }).array(),
