...
export const groupsView = sqliteView('groups_view').as((qb) =>
	qb.select({
		id: groupsTable.id,
...
export const usersToGroupsView = sqliteView('users_to_groups_view').as((qb) =>
	qb.select({
...
export const commentsView = sqliteView('comments_view').as((qb) =>
	qb.select({
		id: commentsTable.id,
...
export const commentLikesView = sqliteView('comment_likes_view').as((qb) =>
	qb.select({
