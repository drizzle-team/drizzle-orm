...
import { s3File, s3FileExt } from 'drizzle-orm/extensions/s3-file/pg';
...
import type { DrizzlePgExtension } from 'drizzle-orm/extension-core/pg';
...
export async function createExtensions(): Promise<DrizzlePgExtension[]> {
