...
test('all data types', (tc) => {
	...
	const expected = t.Object({
		...
		bigint5: new TBigIntString(),
		bigint6: new TUnsignedBigIntString(),
		binary: t.String({ pattern: /^[01]*$/, maxLength: 10 }),
		boolean: t.Boolean(),
