...
test.serial('all date and time columns with timezone first case mode string', async (t) => {
	...
	t.deepEqual([...result2], [{ id: 1, timestamp_string: '2022-01-01 04:00:00.123456+00' }]);
...
test.serial('all date and time columns without timezone second case mode string', async (t) => {
	...
	t.deepEqual([...result], [{ id: 1, timestamp_string: '2022-01-01 04:00:00.123456+00' }]);
...
test.serial('all date and time columns without timezone third case mode date', async (t) => {
	...
	t.deepEqual(new Date(result[0]!.timestamp_string).getTime(), insertedDate.getTime());
