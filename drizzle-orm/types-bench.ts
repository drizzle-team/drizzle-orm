...
bench("relations", () => {
  defineRelations(schema, (r) => ({
    ...
    projectDefinition: {
      labels: r.many.label(),
      stageDefinitionsViaProjectDefinitionStageDefinition:
        r.many.stageDefinition({
          ...
          alias:
            "projectDefinition_id_stageDefinition_id_via_projectDefinitionStageDefinition",
        }),
      userCreatedByUserId: r.one.user({
    ...
    stageDefinition: {
      projectDefinitionsViaProjectDefinitionStageDefinition:
        r.many.projectDefinition({
          alias:
            "projectDefinition_id_stageDefinition_id_via_projectDefinitionStageDefinition",
        }),
      projects: r.many.project(),
