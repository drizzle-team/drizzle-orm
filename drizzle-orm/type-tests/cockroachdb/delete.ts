...
import type { CockroachDbDelete } from '~/cockroachdb-core/index.ts';
...
{
	function dynamic<T extends CockroachDbDelete>(qb: T) {
...
{
	function withReturning<T extends CockroachDbDelete>(qb: T) {
		return qb.returning();
	}
