...
import { cockroachdbTable, int4, text } from '~/cockroachdb-core/index.ts';
...
{
	const providers = cockroachdbTable('providers', {
...

{
	...
	const otherProducts = cockroachdbTable('other_products', {
		id: int4().primaryKey(),
		productName: text().notNull(),
	});
