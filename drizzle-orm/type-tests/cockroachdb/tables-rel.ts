import { cockroachdbTable, foreignKey, int4, text, timestamp } from '~/cockroachdb-core/index.ts';
import { relations } from '~/relations.ts';

export const users = cockroachdbTable('users', {
...
export const cities = cockroachdbTable('cities', {
	id: int4('id').primaryKey(),
	name: text('name').notNull(),
});
...
export const posts = cockroachdbTable('posts', {
	id: int4('id').primaryKey(),
...
export const comments = cockroachdbTable('comments', {
	id: int4('id').primaryKey(),
...
export const books = cockroachdbTable('books', {
	id: int4('id').primaryKey(),
	name: text('name').notNull(),
});
...
export const bookAuthors = cockroachdbTable('book_authors', {
...
export const node = cockroachdbTable('node', {
	id: int4('id').primaryKey(),
