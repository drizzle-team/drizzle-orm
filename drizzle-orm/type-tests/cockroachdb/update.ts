...
import type { CockroachDbUpdate } from '~/cockroachdb-core/index.ts';
...
{
	function dynamic<T extends CockroachDbUpdate>(qb: T) {
...
{
	function withReturning<T extends CockroachDbUpdate>(qb: T) {
		return qb.returning();
	}
