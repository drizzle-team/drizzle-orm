...

{
	mysqlTable('all_columns', {
		...
		decimal2: decimal('decimal2', { mode: 'string' }),
		decimal3: decimal('decimal3', { mode: 'number' }),
		decimal4: decimal('decimal4', { precision: 10 }),
		decimal5: decimal('decimal5', { precision: 10, mode: 'string' }),
		decimal6: decimal('decimal6', { precision: 10, mode: 'number' }),
		decimal7: decimal('decimal7', { precision: 10, scale: 2 }),
		decimal8: decimal('decimal8', { precision: 10, scale: 2, mode: 'string' }),
		decimal9: decimal('decimal9', { precision: 10, scale: 2, mode: 'number' }),
		decimaldef: decimal('decimaldef').default('0'),
		decimaldef2: decimal('decimaldef2', { mode: 'string' }).default('0'),
		decimaldef3: decimal('decimaldef3', { mode: 'number' }).default(0),
...

{
	mysqlTable('all_columns_without_name', {
		...
		datetimedef: datetime('datetimedef').default(new Date()),
		decimal: decimal(),
		decimal2: decimal({ mode: 'string' }),
		decimal3: decimal({ mode: 'number' }),
		decimal4: decimal({ precision: 10 }),
		decimal5: decimal({ precision: 10, mode: 'string' }),
		decimal6: decimal({ precision: 10, mode: 'number' }),
		decimal7: decimal({ precision: 10, scale: 2 }),
		decimal8: decimal({ precision: 10, scale: 2, mode: 'string' }),
		decimal9: decimal({ precision: 10, scale: 2, mode: 'number' }),
		decimaldef: decimal().default('0'),
		decimaldef2: decimal({ mode: 'string' }).default('0'),
		decimaldef3: decimal({ mode: 'number' }).default(0),
		double: double(),
