...
import type { CockroachUpdate } from '~/cockroach-core/index.ts';
...
{
	function dynamic<T extends CockroachUpdate>(qb: T) {
...
{
	function withReturning<T extends CockroachUpdate>(qb: T) {
		return qb.returning();
	}
