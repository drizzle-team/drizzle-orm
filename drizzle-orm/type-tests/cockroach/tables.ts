...
import {
	...
	cockroachEnum,
	cockroachTable,
	type CockroachTableWithColumns,
	customType,
	date,
	decimal,
	doublePrecision,
...
import {
	...
	type CockroachMaterializedViewWithSelection,
	cockroachView,
	type CockroachViewWithSelection,
...
{
	const cities1 = cockroachTable('cities_table', {
		id: int4('id').primaryKey(),
	...
	type Expected = CockroachTableWithColumns<{
		name: 'cities_table';
		schema: undefined;
		dialect: 'cockroach';
		columns: {
