...
import type { CockroachDelete } from '~/cockroach-core/index.ts';
...
{
	function dynamic<T extends CockroachDelete>(qb: T) {
...
{
	function withReturning<T extends CockroachDelete>(qb: T) {
		return qb.returning();
	}
