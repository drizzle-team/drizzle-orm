...
import { getTableConfig, mysqlTable, text } from '~/mysql-core/index.ts';

describe.concurrent('mysql column comment', () => {
	test('mysql column builder has comment method', ({ expect }) => {
