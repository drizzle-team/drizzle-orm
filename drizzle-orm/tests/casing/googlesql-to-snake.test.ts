...
const instance = createPool({
	uri: "googlesql://root:password@localhost:3306/test",
});

const db = spanner({ client: instance, schema: schema, casing: 'snake_case', mode: "default" });
...
describe('googlesql to snake case', () => {
	beforeEach(() => {
