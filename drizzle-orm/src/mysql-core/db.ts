...
> {
	 ...
	 * ```
	 */
	select(): MySqlSelectBuilder<TPreparedQueryHKT>;
	 ...
	 * ```
	 */
	selectDistinct(): MySqlSelectBuilder<TPreparedQueryHKT>;
...
>(
	...
	const $withRecursive: Q['withRecursive'] = (...args: []) => getReplica(replicas).withRecursive(...args);
