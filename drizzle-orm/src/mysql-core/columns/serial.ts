...
import { MySqlColumnBuilder, MySqlColumn } from "./common.ts";
...
export class MySqlSerialBuilder<
  T extends ColumnBuilderBaseConfig<"number", "MySqlSerial">,
> extends MySqlColumnBuilder<T> {
  ...
  override build<TTableName extends string>(
    ...
    return new MySqlSerial<MakeColumnConfig<T, TTableName>>(
      table,
...
export function serial<TName extends string>(
  name: TName
): MySqlSerialBuilderInitial<TName>;
