...
> =
	& Subquery<TAlias, AddAliasToSelection<TSelection, TAlias, 'clickhouse'>>
	& AddAliasToSelection<TSelection, TAlias, 'clickhouse'>;

export type WithSubqueryWithSelection<
	TSelection extends ColumnsSelection,
	TAlias extends string,
> =
	& WithSubquery<TAlias, AddAliasToSelection<TSelection, TAlias, 'clickhouse'>>
	& AddAliasToSelection<TSelection, TAlias, 'clickhouse'>;
