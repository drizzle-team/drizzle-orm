...
export class XataHttpPreparedQuery<T extends PreparedQueryConfig> extends PgPreparedQuery<T> {
  ...
  async execute(placeholderValues: Record<string, unknown> | undefined = {}): Promise<T['execute']> {
    ...
    return customResultMapper
      ...
      : rows.map((row) => mapResultRow<T['execute']>(fields!, row as unknown[], this.joinsNotNullableMap));
  }
...
export class XataHttpSession<TFullSchema extends Record<string, unknown>, TSchema extends TablesRelationalConfig> extends PgSession<
