...
export class CockroachBooleanBuilder<T extends ColumnBuilderBaseConfig<"boolean", "CockroachBoolean">> extends CockroachColumnWithArrayBuilder<T> {
  ...
  /** @internal */
  override build<TTableName extends string>(table: AnyCockroachTable<{ name: TTableName }>): CockroachBoolean<MakeColumnConfig<T, TTableName>> {
    return new CockroachBoolean<MakeColumnConfig<T, TTableName>>(table, this.config as ColumnBuilderRuntimeConfig<any, any>);
  }
}
