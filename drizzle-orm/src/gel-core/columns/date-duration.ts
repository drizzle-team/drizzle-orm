...
export class GelDateDurationBuilder<T extends ColumnBuilderBaseConfig<'dateDuration'>>
...
export class GelDateDuration<T extends ColumnBaseConfig<'dateDuration'>> extends GelColumn<T> {
