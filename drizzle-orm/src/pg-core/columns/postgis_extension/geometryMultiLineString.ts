...
export type PgGeometryMultiLineStringBuilderInitial<TName extends string> =
...
> extends PgColumn<T> {
  ...
  constructor(
    ...
    config: PgGeometryMultiLineStringBuilder<T>['config']
  ) {
    super(table, config);
  ...
  override mapToDriverValue(value: [number, number][][]): string {
    const multilinestring = `MultiLineString(${value
