...
export class PgLineBuilder<T extends ColumnBuilderBaseConfig<'array'>> extends PgColumnBuilder<T> {
...
export class PgLineABCBuilder<T extends ColumnBuilderBaseConfig<'json'>> extends PgColumnBuilder<T> {
