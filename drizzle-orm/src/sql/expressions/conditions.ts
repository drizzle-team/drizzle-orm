...
import { isSQLWrapper, Param, Placeholder, SQL, sql, SQLWrapper } from '..';

function bindIfParam(value: unknown, column: AnyColumn) {
	if (value instanceof Column || value instanceof Placeholder) {
		return value;
	} else {
...
export function eq<TColumn extends AnyColumn>(column: TColumn, value: GetColumnData<TColumn, 'raw'> | Placeholder): SQL;
export function eq(left: AnyColumn, right: AnyColumn): SQL;
export function eq(left: AnyColumn, right: unknown) {
	return sql`${left} = ${bindIfParam(right, left)}`;
}

export function ne<TColumn extends AnyColumn>(column: TColumn, value: GetColumnData<TColumn> | Placeholder): SQL;
...
export function gt<TColumn extends AnyColumn>(column: TColumn, value: GetColumnData<TColumn> | Placeholder): SQL;
export function gt(left: AnyColumn, right: AnyColumn): SQL;
export function gt(left: AnyColumn, right: unknown) {
	return sql`${left} > ${bindIfParam(right, left)}`;
}

export function gte<TColumn extends AnyColumn>(column: TColumn, value: GetColumnData<TColumn> | Placeholder): SQL;
export function gte(left: AnyColumn, right: AnyColumn): SQL;
export function gte(left: AnyColumn, right: unknown) {
	return sql`${left} >= ${bindIfParam(right, left)}`;
}

export function lt<TColumn extends AnyColumn>(column: TColumn, value: GetColumnData<TColumn> | Placeholder): SQL;
export function lt(left: AnyColumn, right: AnyColumn): SQL;
export function lt(left: AnyColumn, right: unknown) {
	return sql`${left} < ${bindIfParam(right, left)}`;
}

export function lte<TColumn extends AnyColumn>(column: TColumn, value: GetColumnData<TColumn> | Placeholder): SQL;
...
export function inArray<TColumn extends AnyColumn>(
	column: TColumn,
	values: (GetColumnData<TColumn> | Placeholder)[],
): SQL;
...
export function between<TColumn extends AnyColumn>(
	column: TColumn,
	min: GetColumnData<TColumn, 'raw'> | Placeholder,
	max: GetColumnData<TColumn, 'raw'> | Placeholder,
): SQL {
