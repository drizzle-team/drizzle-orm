...
> extends SQLiteSession<'async', TursoDatabaseServerlessRunResult, TFullSchema, TRelations, TSchema> {
	...
	override async transaction<T>(
		...
		const localTx = new TursoDatabaseServerlessTransaction<TFullSchema, TRelations, TSchema>(
			'async',
			this.dialect,
			session,
			this.relations,
...
> extends SQLiteTransaction<'async', TursoDatabaseServerlessRunResult, TFullSchema, TRelations, TSchema> {
	...
	override async transaction<T>(
		transaction: (tx: TursoDatabaseServerlessTransaction<TFullSchema, TRelations, TSchema>) => Promise<T>,
	): Promise<T> {
