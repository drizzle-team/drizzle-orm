...
export const bufferSchema = type.unknown.narrow((value) => value instanceof Buffer).as<Buffer>().describe( // oxlint-disable-line no-instanceof-builtins drizzle-internal/no-instanceof
	'a Buffer instance',
);
