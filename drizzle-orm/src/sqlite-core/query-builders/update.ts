...
> {
  ...
  ): SQLiteUpdate<TTable, TResultType, TRunResult> {
  ...
  implements SQLWrapper
{
  ...
  returning<TSelectedFields extends SelectedFields>(
    ...
    TResultType,
    TRunResult,
    Simplify<SelectResultFields<TSelectedFields>>
  >;
  returning(
  ...
  > {
    return (
      this.config.returning ? this.all() : this.run()
    ) as TReturning extends undefined ? TRunResult : TReturning[];
  }
}
