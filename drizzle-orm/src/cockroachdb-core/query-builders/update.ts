...
export interface CockroachDbUpdateConfig {
	where?: SQL | undefined;
	set: UpdateSet;
	table: CockroachDbTable;
	from?: CockroachDbTable | Subquery | CockroachDbViewBase | SQL;
...
export type CockroachDbUpdateSetSource<TTable extends CockroachDbTable> =
	& {
...
export class CockroachDbUpdateBuilder<TTable extends CockroachDbTable, TQueryResult extends CockroachDbQueryResultHKT> {
	static readonly [entityKind]: string = 'CockroachDbUpdateBuilder';
	...
	set(
		values: CockroachDbUpdateSetSource<TTable>,
	): CockroachDbUpdateWithout<
		CockroachDbUpdateBase<TTable, TQueryResult>,
		false,
		'leftJoin' | 'rightJoin' | 'innerJoin' | 'fullJoin'
	> {
		return new CockroachDbUpdateBase<TTable, TQueryResult>(
			this.table,
...
export type CockroachDbUpdateWithout<
	T extends AnyCockroachDbUpdate,
	TDynamic extends boolean,
	K extends keyof T & string,
> = TDynamic extends true ? T : Omit<
	CockroachDbUpdateBase<
		T['_']['table'],
		T['_']['queryResult'],
		T['_']['from'],
		T['_']['selectedFields'],
...
export type CockroachDbUpdateWithJoins<
	T extends AnyCockroachDbUpdate,
	TDynamic extends boolean,
	TFrom extends CockroachDbTable | Subquery | CockroachDbViewBase | SQL,
> = TDynamic extends true ? T : Omit<
	CockroachDbUpdateBase<
		T['_']['table'],
		T['_']['queryResult'],
...
export type CockroachDbUpdateJoinFn<
	T extends AnyCockroachDbUpdate,
	TDynamic extends boolean,
	...
	on:
		| (
			(
				...
				from: T['_']['from'] extends CockroachDbTable ? T['_']['from']['_']['columns']
					: T['_']['from'] extends Subquery | CockroachDbViewBase ? T['_']['from']['_']['selectedFields']
					: never,
			) => SQL | undefined
		)
		| SQL
		| undefined,
) => CockroachDbUpdateJoin<T, TDynamic, TJoinType, TJoinedTable>;

export type CockroachDbUpdateJoin<
	T extends AnyCockroachDbUpdate,
	TDynamic extends boolean,
	TJoinType extends JoinType,
	TJoinedTable extends CockroachDbTable | Subquery | CockroachDbViewBase | SQL,
> = TDynamic extends true ? T : CockroachDbUpdateBase<
	T['_']['table'],
	T['_']['queryResult'],
	T['_']['from'],
	T['_']['selectedFields'],
...
export type CockroachDbUpdateReturningAll<T extends AnyCockroachDbUpdate, TDynamic extends boolean> =
	CockroachDbUpdateWithout<
		CockroachDbUpdateBase<
			T['_']['table'],
			T['_']['queryResult'],
...
export type CockroachDbUpdateReturning<
	T extends AnyCockroachDbUpdate,
	TDynamic extends boolean,
...
export type CockroachDbUpdatePrepare<T extends AnyCockroachDbUpdate> = CockroachDbPreparedQuery<
	PreparedQueryConfig & {
...
export type CockroachDbUpdateDynamic<T extends AnyCockroachDbUpdate> = CockroachDbUpdate<
	T['_']['table'],
	T['_']['queryResult'],
	T['_']['from'],
	T['_']['returning'],
...
export type AnyCockroachDbUpdate = CockroachDbUpdateBase<any, any, any, any, any, any, any, any, any>;

export interface CockroachDbUpdateBase<
...
export class CockroachDbUpdateBase<
	TTable extends CockroachDbTable,
	TQueryResult extends CockroachDbQueryResultHKT,
	TFrom extends CockroachDbTable | Subquery | CockroachDbViewBase | SQL | undefined = undefined,
...
> extends QueryPromise<TReturning extends undefined ? CockroachDbQueryResultKind<TQueryResult, never> : TReturning[]>
	implements
		...
		SQLWrapper
{
	static override readonly [entityKind]: string = 'CockroachDbUpdate';

	private config: CockroachDbUpdateConfig;
	...
	from<TFrom extends CockroachDbTable | Subquery | CockroachDbViewBase | SQL>(
		source: TableLikeHasEmptySelection<TFrom> extends true ? DrizzleTypeError<
			...
			>
			: TFrom,
	): CockroachDbUpdateWithJoins<this, TDynamic, TFrom> {
	...
	private getTableLikeFields(table: CockroachDbTable | Subquery | CockroachDbViewBase): Record<string, unknown> {
	...
	private createJoin<TJoinType extends JoinType>(
		joinType: TJoinType,
	): CockroachDbUpdateJoinFn<this, TDynamic, TJoinType> {
		return ((
			table: CockroachDbTable | Subquery | CockroachDbViewBase | SQL,
	 ...
	 * ```
	 */
	where(where: SQL | undefined): CockroachDbUpdateWithout<this, TDynamic, 'where'> {
	 ...
	 * ```
	 */
	returning(): CockroachDbUpdateReturningAll<this, TDynamic>;
	returning<TSelectedFields extends SelectedFields>(
		fields: TSelectedFields,
	): CockroachDbUpdateReturning<this, TDynamic, TSelectedFields>;
	returning(
		fields?: SelectedFields,
	): CockroachDbUpdateWithout<AnyCockroachDbUpdate, TDynamic, 'returning'> {
		if (!fields) {
	...
	/** @internal */
	_prepare(name?: string): CockroachDbUpdatePrepare<this> {
	...
	prepare(name: string): CockroachDbUpdatePrepare<this> {
	...
	$dynamic(): CockroachDbUpdateDynamic<this> {
		return this as any;
	}
}
