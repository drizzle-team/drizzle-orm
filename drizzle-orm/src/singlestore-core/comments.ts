...
export class CommentBuilder {
	static readonly [entityKind]: string = 'SingleStoreTableCommentBuilder';

	protected brand!: 'SingleStoreTableCommentBuilder';
...
export class Comment {
	static readonly [entityKind]: string = 'SingleStoreTableComment';
